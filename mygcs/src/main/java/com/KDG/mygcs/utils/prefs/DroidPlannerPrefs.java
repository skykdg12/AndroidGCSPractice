package com.KDG.mygcs.utils.prefs;
...
import com.KDG.mygcs.utils.Utils;
...
public class DroidPlannerPrefs {
    ...
    private static com.KDG.mygcs.utils.prefs.DroidPlannerPrefs instance;

    public static synchronized com.KDG.mygcs.utils.prefs.DroidPlannerPrefs getInstance(Context context) {
        if (instance == null) {
            instance = new com.KDG.mygcs.utils.prefs.DroidPlannerPrefs(context);
        }
